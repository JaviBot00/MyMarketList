    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSaveUser.setOnClickListener {
            ...
            if (textInputUsername.editText!!.text.isNullOrEmpty() || !validUser) {
                textInputUsername.error = resources.getString(R.string.set_valid_username)
                return@setOnClickListener
            }
            if (textInputPassword.editText!!.text.isNullOrEmpty() || !validPassword) {
                textInputPassword.error = resources.getString(R.string.set_valid_password)
                return@setOnClickListener
            }
            if (textInputEmail.editText!!.text.isNullOrEmpty() || !validEmail) {
                textInputEmail.error = resources.getString(R.string.set_valid_email)
                return@setOnClickListener
            }
